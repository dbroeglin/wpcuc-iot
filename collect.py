...
data = [
        ...
        { 'name': 'OHCompressor2', 'function': 4, 'addr': 2225, 'size': 2, 'datatype': DATA_TYPES['Float'] },
        ...
        { 'name': 'OHPoolCompressor', 'function': 4, 'addr': 2385, 'size': 2, 'datatype': DATA_TYPES['Float'] },
        { 'name': 'OHCooling', 'function': 4, 'addr': 2417, 'size': 2, 'datatype': DATA_TYPES['Float'] },
        { 'name': 'Pincode', 'function': 4, 'addr': 2465, 'size': 2, 'datatype': DATA_TYPES['Int'] },
